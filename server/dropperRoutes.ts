/**
 * Rotas REST para o APK Dropper Builder
 * POST /api/dropper/build  — recebe APK payload + ícone + nome, inicia build
...
import { createDropperJob, getDropperJob, updateDropperJob } from "./dropperDb";
